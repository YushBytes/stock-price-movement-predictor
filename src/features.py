...
Phase 5/6 will implement raw OHLCV lag features and technical indicators
...
def build_raw_features(df: pd.DataFrame) -> pd.DataFrame:
    """Build lagged raw OHLCV features. Implemented in Phase 5."""
    raise NotImplementedError("Raw feature construction will be implemented in Phase 5.")


def build_technical_indicators(df: pd.DataFrame) -> pd.DataFrame:
    """Build technical-indicator features. Implemented in Phase 6."""
    raise NotImplementedError("Technical indicators will be implemented in Phase 6.")
